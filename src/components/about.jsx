...
export const About = () => {
  return (
    <div id="about" className="bg-white max-w-[1440px] w-full py-10 Unbounded-Regular  responsive-flex page-padding  space-y-8 md:space-y-0 md:space-x-10 border-bottom">
