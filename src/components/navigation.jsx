...
export const Navigation = () => {
  return (
    <nav className="fixed top-0 max-w-[1440px]  w-full bg-white flex items-center justify-between py-5 Unbounded-Regular border-b border-black-primary page-padding">
